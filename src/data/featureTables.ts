...
export const WEAPON_MASTERY_MELEE: TableOption[] = [
  { id: 'club', name: 'Garrote', description: '1d4 contundente — ligera. Puedes usar su propiedad de maestría.' },
  { id: 'dagger', name: 'Daga', description: '1d4 perforante — sutil, ligera, arrojadiza (20/60). Puedes usar su propiedad de maestría.' },
  { id: 'greatclub', name: 'Garrote grande', description: '1d8 contundente — a dos manos. Puedes usar su propiedad de maestría.' },
  { id: 'handaxe', name: 'Hacha de mano', description: '1d6 cortante — ligera, arrojadiza (20/60). Puedes usar su propiedad de maestría.' },
  { id: 'javelin', name: 'Jabalina', description: '1d6 perforante — arrojadiza (30/120). Puedes usar su propiedad de maestría.' },
  { id: 'light-hammer', name: 'Martillo ligero', description: '1d4 contundente — ligera, arrojadiza (20/60). Puedes usar su propiedad de maestría.' },
  { id: 'mace', name: 'Maza', description: '1d6 contundente — sin propiedades especiales listadas. Puedes usar su propiedad de maestría.' },
  { id: 'quarterstaff', name: 'Bastón', description: '1d6 contundente — versátil (1d8). Puedes usar su propiedad de maestría.' },
  { id: 'sickle', name: 'Hoz', description: '1d4 cortante — ligera. Puedes usar su propiedad de maestría.' },
  { id: 'spear', name: 'Lanza', description: '1d6 perforante — arrojadiza (20/60), versátil (1d8). Puedes usar su propiedad de maestría.' },
  { id: 'battleaxe', name: 'Hacha de batalla', description: '1d8 cortante — versátil (1d10). Puedes usar su propiedad de maestría.' },
  { id: 'flail', name: 'Mayal', description: '1d8 contundente — sin propiedades especiales listadas. Puedes usar su propiedad de maestría.' },
  { id: 'glaive', name: 'Guja', description: '1d10 cortante — pesada, alcance, a dos manos. Puedes usar su propiedad de maestría.' },
  { id: 'greataxe', name: 'Hacha grande', description: '1d12 cortante — pesada, a dos manos. Puedes usar su propiedad de maestría.' },
  { id: 'greatsword', name: 'Espada grande', description: '2d6 cortante — pesada, a dos manos. Puedes usar su propiedad de maestría.' },
  { id: 'halberd', name: 'Alabarda', description: '1d10 cortante — pesada, alcance, a dos manos. Puedes usar su propiedad de maestría.' },
  { id: 'lance', name: 'Lanza de caballería', description: '1d12 perforante — alcance, especial. Puedes usar su propiedad de maestría.' },
  { id: 'longsword', name: 'Espada larga', description: '1d8 cortante — versátil (1d10). Puedes usar su propiedad de maestría.' },
  { id: 'maul', name: 'Martillo de guerra grande', description: '2d6 contundente — pesada, a dos manos. Puedes usar su propiedad de maestría.' },
  { id: 'morningstar', name: 'Lucero del alba', description: '1d8 perforante — sin propiedades especiales listadas. Puedes usar su propiedad de maestría.' },
  { id: 'pike', name: 'Pica', description: '1d10 perforante — pesada, alcance, a dos manos. Puedes usar su propiedad de maestría.' },
  { id: 'rapier', name: 'Estoque', description: '1d8 perforante — sutil. Puedes usar su propiedad de maestría.' },
  { id: 'scimitar', name: 'Cimitarra', description: '1d6 cortante — sutil, ligera. Puedes usar su propiedad de maestría.' },
  { id: 'shortsword', name: 'Espada corta', description: '1d6 perforante — sutil, ligera. Puedes usar su propiedad de maestría.' },
  { id: 'trident', name: 'Tridente', description: '1d6 perforante — arrojadiza (20/60), versátil (1d8). Puedes usar su propiedad de maestría.' },
  { id: 'war-pick', name: 'Pico de guerra', description: '1d8 perforante — sin propiedades especiales listadas. Puedes usar su propiedad de maestría.' },
  { id: 'warhammer', name: 'Martillo de guerra', description: '1d8 contundente — versátil (1d10). Puedes usar su propiedad de maestría.' },
  { id: 'whip', name: 'Látigo', description: '1d4 cortante — sutil, alcance. Puedes usar su propiedad de maestría.' },
];
